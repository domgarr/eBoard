...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/core */
    "./node_modules/@angular/core/fesm2015/core.js"); //https://developers.google.com/web/updates/2015/07/interact-with-ble-devices-on-the-web
    ...
    function () {
      function AppComponent(ref) {
        ...
        this.redScore = 0;
        this.blueScore = 0; //The Scoreboards can share the same characteris identifers.

        this.SCOREBOARD_CHAR_RED = "0000aaaa-0000-1000-8000-00805f9b34fb";
        this.SCOREBOARD_CHAR_BLUE = "0000bbbb-0000-1000-8000-00805f9b34fb"; //Aslong as the service identifer are unique. You can connect to multiple scoreboards in one room.
      ...
      _createClass(AppComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //Bluetooth logic

      }, {
        key: "connectBte",
        value: function connectBte() {
          var _this = this;
          ...
          this.navigator.bluetooth.requestDevice({
            ...
            _this.onConnect(device.name);

            device.addEventListener('gattserverdisconnected', function (event) {
              return _this.onDisconnected(event);
            });
            return device.gatt.connect();
          }).then(function (server) {
            if (_this.deviceName.localeCompare(_this.SCOREBOARD_NAME_1) == 0) {
              return server.getPrimaryService(_this.SCOREBOARD_SERVICE_UUID_1);
            } else if (_this.deviceName.localeCompare(_this.SCOREBOARD_NAME_2) == 0) {
              return server.getPrimaryService(_this.SCOREBOARD_SERVICE_UUID_2);
            } else if (_this.deviceName.localeCompare(_this.SCOREBOARD_NAME_3) == 0) {
              return server.getPrimaryService(_this.SCOREBOARD_SERVICE_UUID_3);
            } else {
              return null;
            }
          }).then(function (service) {
            _this.redScoreChar = service.getCharacteristic(_this.SCOREBOARD_CHAR_RED);
            _this.blueScoreChar = service.getCharacteristic(_this.SCOREBOARD_CHAR_BLUE);

            _this.onServiceConnect();
        ...
        key: "writeToBlueChar",
        value: function writeToBlueChar(score) {
          if (this.blueScoreChar != null && this.connected) {
            this.blueScoreChar.then(function (char) {
              var value = Uint8Array.of(score);
        ...
        key: "writeToRedChar",
        value: function writeToRedChar(score) {
          if (this.redScoreChar != null && this.connected) {
            this.redScoreChar.then(function (char) {
              var value = Uint8Array.of(score);
              char.writeValue(value);
            }).catch(function (error) {
              console.log("Not connected to Service yet.");
        ...
        key: "onConnect",
        value: function onConnect(deviceName) {
        ...
        key: "onServiceConnect",
        value: function onServiceConnect() {
          this.connected = true;
        ...
        key: "getServicesCharacteristic",
        value: function getServicesCharacteristic(characteristics) {
        ...
        key: "decrementScore",
        value: function decrementScore(value) {
          if (value <= 0) {
            return 0;
          }
        ...
        key: "prependZeroAndConvertToString",
        value: function prependZeroAndConvertToString(score) {
          if (score <= 9) {
            return "0" + score;
          }
        ...
        value: function resetScore() {
          ...
          if (confirm("Are you sure you want to reset the scores?")) {
            ...
            this.writeToRedChar(this.redScore);
            setTimeout(function () {
              _this2.writeToBlueChar(_this2.blueScore);
            }, 250);
          }
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("bteIcon", {
      static: false
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Domenico\Desktop\Web\eBoardWebApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
